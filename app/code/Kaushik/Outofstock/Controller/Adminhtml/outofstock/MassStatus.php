...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('outofstock');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Kaushik\Outofstock\Model\Outofstock')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('outofstock/*/index');
    }
